...
public class ShapeTester {
	   public static void main(String[] args) {
		...
		/////////////BONUS////////////////
		  ...
		  Circle s6 = new Circle("Blue",10);
		  System.out.println(s6);//Run Circle toString()
		  System.out.println("Area is " + s6.getArea());//Run Circle getArea;

		  Circle s7 = new Circle();
		  s7.setColor("Green");
		  System.out.println("--Test overload method--");
	      System.out.println("Area is " + s7.getArea(10));  // Run Circle's getArea()
